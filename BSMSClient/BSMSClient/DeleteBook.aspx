<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteBook.aspx.cs" Inherits="BSMSClient.DeleteBook" %>
         ...
         <div class="col-md-6">
             <form runat="server">
                 <div class="form-group">
                     ...
                     <input runat="server" type="text" id="txttitle" class="form-control" placeholder="Enter Title To Delete" required="required" 
