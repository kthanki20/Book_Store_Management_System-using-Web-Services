<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddBook.aspx.cs" Inherits="BSMSClient.AddBook" %>
...
<body>
     ...
     <div class="container">
     <h2 class="mt-5 mb-4">Add Book</h2>
     <div class="row">
         <div class="col-md-6">
             <form runat="server">
                 ...
                 <asp:Button runat="server" ID="btnSignUp" Text="Add Book" CssClass="btn btn-primary" OnClick="btnSignUp_Click" /><asp:Label runat="server" Text="Label" ID="insertLabel"></asp:Label>
                  <p class="mt-2">Update Information <a href="UpdateBookDetails.aspx">Click to Update!</a></p>
                  <p class="mt-2">Delete Information <a href="DeleteBook.aspx">Click to Delete!</a></p>
