<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DeleteOrder.aspx.cs" Inherits="BSMSClient.DeleteOrder" %>
         ...
         <div class="col-md-6">
             <form runat="server">
                 <div class="form-group">
                     <asp:Label runat="server" AssociatedControlID="txtOid">Order_Id</asp:Label>
                     <input runat="server" type="number" id="txtOid" class="form-control" placeholder="Enter your Identity" required="required" 
                         oninvalid="this.setCustomValidity('Id is required')" oninput="this.setCustomValidity('')"/>
                 </div>
